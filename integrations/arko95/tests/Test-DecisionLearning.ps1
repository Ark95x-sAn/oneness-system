...
try {
    ...
    foreach ($configName in @('capabilities.json','connector-registry.json','delegation-roster.json','mission-control.json','operations-vp.json','decision-learning.json','pc-binding.json')) {
