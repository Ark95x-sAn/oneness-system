...
if (-not $jsonCommand.Parameters.ContainsKey('DateKind')) {
    throw 'ARKO-95 requires PowerShell 7 with ConvertFrom-Json -DateKind support. Launch it with pwsh.exe, not Windows PowerShell 5.1.'
}
